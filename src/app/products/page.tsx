      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <motion.div
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl">
            Discover and purchase pre-built SaaS starter kits from talented
            creators
          </p>
        </motion.div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    Demo Mode: Click confirm to complete purchase. In
                    production, this would integrate with Stripe.
                  </p>
                </div>

                <p className="text-xs text-gray-500 dark:text-gray-400">
                  By confirming, you agree to the terms of service and will
                  receive a license key to access this product.
                </p>
              </div>
